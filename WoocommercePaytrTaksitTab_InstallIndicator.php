<?php
include_once('WoocommercePaytrTaksitTab_OptionsManager.php');

class WoocommercePaytrTaksitTab_InstallIndicator extends WoocommercePaytrTaksitTab_OptionsManager {
