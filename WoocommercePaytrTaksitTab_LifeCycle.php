<?php
include_once('WoocommercePaytrTaksitTab_InstallIndicator.php');

class WoocommercePaytrTaksitTab_LifeCycle extends WoocommercePaytrTaksitTab_InstallIndicator {
